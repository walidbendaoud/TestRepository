  ...
  <div >
    ...
    <a-form :form="form" :label-col="{ span: 5 }" :wrapper-col="{ span: 12 }" @submit.prevent="handleSubmit" >
      ...
      <a-form-item label="msisdn">
        <a-input
          v-decorator="['msisdn', { rules: [{ required: true, message: 'Please input your msisdn!' }] }]"
        />
      </a-form-item>
      <a-form-item label="csid">
        <a-input
          v-decorator="['csid', { rules: [{ required: true, message: 'Please input your customer id!' }] }]"
        />
      </a-form-item>
      <a-form-item :wrapper-col="{ span: 12, offset: 5 }">
        ...
        <a-button html-type="button" @click="$router.push('/users')">
          Cancel
        </a-button>
      </a-form-item>
    </a-form>
