...
export default defineNuxtConfig({
  ...
  buildModules: [
    ...
    // ['@pinia/nuxt', { disableVuex: true }], // activate this module once nuxt pinia fix bug
    ['~/temp/pinia-nuxt', { disableVuex: false }], //used momentanly to resolve production mode ==> waiting fix from nuxt pinia
  ],
