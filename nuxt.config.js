...
export default defineNuxtConfig({
  ...
  publicRuntimeConfig: {
    ...
    COLLECTION: ['Product', 'Service', 'Template'],
    DB: process.env.DB,
    APPS: process.env.APPS,
    WS_AGGREGATOR_LIST: '/services/otcdsservices/api/aggregators/',
    WS_TEMPLATES_LIST: '/services/otcdslandingpage/api/templates/countryIsoCode/',
    WS_TEMPLATES_ITEM: '/services/otcdslandingpage/api/templates/',
    WS_TEMPLATES_SELECT_LIST: '/services/otcdslandingpage/api/templates/predefined/countryIsoCode/',
    WS_TEMPLATES_ADD_PREVIEW: '/services/otcdsassets/api/upload'
  },
